...
layout = [
    [sg.Text("Image file")],
    [sg.Input(key='image_path', size=(60, 1)), sg.FileBrowse(file_types=(("Image Files", "*.jpg"), ("Image Files", "*.jpeg"), ("Image Files", "*.png"), ("Image Files", "*.bmp"), ("Image Files", "*.jfif")))],
...
def RemoveAlpha(image, backgroundColor = (255, 255, 255)):
    ...
    bounds = (displaySize.width * 0.88, displaySize.height * 0.74)
